...
const RegisterScreen = () => {
    ...
    const handleSubmit = async () => {
        ...
        const payload = {
            ...
            mobNumber: secondaryPhoneNumber || "",
            pan: panNumber || "",
        ...
        try {
            ...
            if (response.ok) {
                ...
                navigation.push("auth/signinScreen"); // Pass phoneNumber
            } else {
            ...
            <View style={{ flex: 1, }}>
                ...
                <ScrollView automaticallyAdjustKeyboardInsets={true} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{
                        ...
                        // borderTopWidth: 2, // Adjust thickness
                        height: "100%",
                        elevation: 20,
                        paddingBottom: 50
                        ...
                        <View style={styles.navigationButtonsContainer}>
                            {currentStage > 1 && (
                                ...
                                >
                                    <Text style={{ ...Fonts.whiteColor19Medium, color: Colors.companyPrimary, fontStyle: "bold" }}>Back</Text>
                                </TouchableOpacity>
                            )}
                            {currentStage < 4 && (
                                <TouchableOpacity
                                    ...
                                    style={styles.navigationButton}
                                >
                                    <Text style={{ ...Fonts.whiteColor19Medium, color: Colors.companyPrimary }}>Next</Text>
                                </TouchableOpacity>
                            )}
                        </View>

                        {/* Submit Button (Continue Button) */}
                        {currentStage === 4 && continueButton()}
                    </View>
                </ScrollView>
            </View>
        </View>
    ...
    function drugLicense20BExpiryTextField() {
        // return (
        //     <View>
        //         <TouchableOpacity onPress={showDrugLicensePicker} style={styles.textFieldStyle}>
        //             <FontAwesome name="calendar" size={20} color={Colors.companyPrimary} style={{ marginRight: 10 }} />
        //             <Text style={{ color: Colors.companyPrimary }}>
        //                 {drugLicense20BExpiry ? new Date(drugLicense20BExpiry).toLocaleDateString() : "Select Drug License 20B Expiry"}
        //             </Text>
        //         </TouchableOpacity>
        ...
        return (
            <View style={styles.inputContainer}>
                ...
                <TouchableOpacity onPress={pickImage} style={styles.inputWrapper}>
                    <ImageIcon size={20} color={Colors.companyPrimary} style={styles.icon} />
                    <Text style={{ color: Colors.companyPrimary }}>
                        {foodLicenseImage ? "Image Selected" : "Select Drug License 21B Image"}
                    </Text>
                </TouchableOpacity>
            </View>
    ...
    function foodLicenseExpiryTextField() {
        // return (
        //     <View>
        //         <TouchableOpacity onPress={showFoodLicensePicker} style={styles.textFieldStyle}>
        //             <FontAwesome name="calendar" size={20} color={Colors.companyPrimary} style={{ marginRight: 10 }} />
        //             <Text style={{ color: Colors.companyPrimary }}>
