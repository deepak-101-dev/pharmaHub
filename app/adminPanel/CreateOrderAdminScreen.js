    ...
    return (
        ...
        >
            <Card style={{ padding: 25, borderRadius: 20, elevation: 5, backgroundColor: "#FFFFFF" }}>
                <Text style={{ fontSize: 22, fontWeight: "bold", color: "#4CAF50", marginBottom: 15, textAlign: "center" }}>📦 Create Order</Text>
                ...
                <Button mode="contained" style={{ marginTop: 15, borderRadius: 10, backgroundColor: "#4CAF50" }}>
                    Proceed to Order
                </Button>
            </Card>
        </ImageBackground>
