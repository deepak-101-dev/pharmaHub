                ...
                <Card style={styles.card}>
                    <View style={{ zIndex: 2 }}>
                        <DropDownPicker
                            ...
                            style={{ borderColor: "#4CAF50", borderRadius: 15, marginBottom: 15 }}
                            dropDownContainerStyle={{ borderColor: "#4CAF50" }}
                        />
                    </View>
                    ...
                    <Button title="Save" color="#4CAF50" onPress={handleSavePaymentOption} disabled={!chemist} />
                </Card>
            </View>
        </ImageBackground>
    );
...
//                 <Text style={{ fontSize: 22, fontWeight: "bold", color: "#4CAF50", marginBottom: 15, textAlign: "center" }}>💳 Configure Chemist Payment Option</Text>
...
//                     <Text style={{ fontSize: 16, color: "#4CAF50", marginRight: 10 }}>Allow Order Without Payment</Text>
//                     <Switch
//                         value={allowOrderWithoutPayment}
//                         onValueChange={setAllowOrderWithoutPayment}
//                         trackColor={{ false: "#767577", true: "#4CAF50" }}
