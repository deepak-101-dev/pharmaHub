    ...
    return (
        ...
        >
            <Card style={{ padding: 25, borderRadius: 20, elevation: 5, backgroundColor: "#FFFFFF" }}>
                <Text style={{ fontSize: 22, fontWeight: "bold", color: "#4CAF50", marginBottom: 15, textAlign: "center" }}>📦 Inventory Information</Text>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <View style={{ flexDirection: 'row', alignItems: 'center', padding: 15, borderBottomWidth: 1, borderBottomColor: "#ddd" }}>
                            <MaterialIcons name="medical-services" size={24} color="#4CAF50" style={{ marginRight: 10 }} />
                            <View>
